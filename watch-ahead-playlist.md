...
## Before the Wk 2 session · Data modeling & relations — assigned with wk-1 homework

- 🎬 freeCodeCamp — *Relational Database Design – Full Course* (watch the
  first ~40 min: ER modeling, entities, relationships):
...
- 🎬 Software Developer Diaries — *Database Migrations Explained*:
  <https://www.youtube.com/watch?v=mMsZPZKNc4g>
- 🎬 Anton Putra — *6 SQL Joins you MUST know! (Animated + Practice)*:
...
- 🎬 IBM Technology — *What is a REST API?*:
  <https://www.youtube.com/watch?v=SLwpqD8n3d0>
- 🎬 Traversy Media — *HTTP Crash Course & Exploration* (headers, cookies,
  status codes): <https://www.youtube.com/watch?v=iYM2zFP3Zn0>
...
- 🎬 Fireship — *CSS Flexbox in 100 Seconds*:
...
- 🎬 Philip Roberts — *What the heck is the event loop anyway?* (JSConf EU —
  the classic, 26 min): <https://www.youtube.com/watch?v=8aGhZQkoFbQ>
- 🎬 Fireship — *JavaScript Promise in 100 Seconds*:
  <https://www.youtube.com/watch?v=RvYYCGs45L4> + *The Async Await Episode I
...
- 🎬 *Web Accessibility Tutorial (A11y) — Keyboard Navigation, Aria, Contrast,
  Semantics*: <https://www.youtube.com/watch?v=VyWRmepESoQ>
...
- 🎬 ByteByteGo — *OAuth 2 Explained In Simple Terms*:
...
- 🎬 Fireship — *Software Testing Explained in 100 Seconds*:
  <https://www.youtube.com/watch?v=u6QfIXgjwGQ>
- 🎬 *How to Systematically Set Up LLM Evals* (metrics, unit tests,
  LLM-as-a-judge): <https://www.youtube.com/watch?v=a3SMraZWNNs>
...
- 🎬 Hussein Nasser — *Database Indexing Explained (with PostgreSQL)*:
